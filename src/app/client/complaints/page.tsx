...
export default function ClientComplaintsPage() {
  const [complaints, setComplaints] = useState<Complaint[]>([
    { id: "CMP-1025", customer: "Arjun Raman", description: "Slow internet connection in Anna Nagar", category: "Broadband", priority: "High", status: "In Progress", time: "15 mins ago" },
    { id: "CMP-1031", customer: "Meena K.", description: "Double charge disputation on August statement", category: "Billing", priority: "Urgent", status: "Open", time: "1 hour ago" },
    { id: "CMP-1029", customer: "Suresh V.", description: "Tower signal drops persistently in mornings", category: "Network", priority: "Urgent", status: "Open", time: "2 hours ago" },
    { id: "CMP-1022", customer: "Lakshmi N.", description: "eSIM activation link is showing an error", category: "SIM", priority: "Medium", status: "Resolved", time: "1 day ago" },
  ]);
  ...
  return (
    <main className="p-6 md:p-12 space-y-8 max-w-6xl w-full mx-auto">
      ...
      {/* Filters and Search */}
      <div className="flex bg-card-bg p-4 border border-border-beige rounded shadow-sm justify-between items-center gap-4">
          ...
          >
            <Link href={`/client/complaints/${c.id}`} className="space-y-2 flex-1 min-w-0 hover:opacity-90 block">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-xs font-semibold text-plum font-mono">{c.category.toUpperCase()}</span>
