                  ...
                  <div className="col-span-2 space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      {user?.emailVerified ? (
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-mono font-semibold px-2 py-0.5 bg-red-50 text-red-600 border border-red-200 rounded flex items-center gap-1">
                          ...
                          {!showOtpInput && (
                            <button
                              ...
                              disabled={otpLoading}
                              className="text-[11px] font-mono font-semibold px-2 py-0.5 bg-[#6C5CE7] hover:bg-[#5A4AD1] text-white rounded border border-[#6C5CE7] transition-all cursor-pointer disabled:opacity-50"
                            >
                    ...
                    {showOtpInput && (
                      <form onSubmit={handleVerifyOtp} className="space-y-2 p-3 bg-[#FDFBF7] border border-[#EBE6E0] rounded animate-fade-in max-w-sm">
                        <label className="block text-[10px] font-mono text-plum uppercase tracking-wider">
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="px-3 py-1.5 bg-background border border-border-beige rounded text-xs focus:outline-none focus:border-accent w-32 font-mono text-center tracking-widest text-sm"
                            required
                          />
                          <button
                            type="submit"
                            disabled={otpLoading || otpCode.length !== 6}
                            className="px-4 py-1.5 bg-[#1E0A2D] hover:bg-[#2F1442] text-white text-xs font-semibold rounded transition-colors disabled:opacity-50 cursor-pointer"
                          >
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 border border-border-beige hover:bg-[#F5EFEB] text-plum text-xs rounded cursor-pointer"
                          >
                            Cancel
                          </button>
                        </div>
